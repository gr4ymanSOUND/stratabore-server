...
async function populateInitialData() {
    ...
    const usersToCreate =   [
      ...
      // includes jobDate in jobs table
      // const jobsToCreate = [
      //   {jobNumber: 'EWL-227', client: 'EWL', location: 'Plano, TX', numHoles: 3, numFeet: 60, jobDate: '2023-05-02', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'TER-321', client: 'TER', location: 'Sachse, TX', numHoles: 1, numFeet: 20, jobDate: '2023-05-05', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'AAA-111', client: 'AAA', location: 'Parker, TX', numHoles: 5, numFeet: 1000, jobDate: '2023-05-04', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'ZZZ-2626', client: 'ZZZ', location: 'Lucas, TX', numHoles: 3, numFeet: 120, jobDate: '2023-05-01', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'ZZZ-2627', client: 'ZZZ', location: 'Frisco, TX', numHoles: 2, numFeet: 100, jobDate: '2023-05-02', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'ZZZ-2628', client: 'ZZZ', location: 'McKinney, TX', numHoles: 4, numFeet: 80, jobDate: '2023-05-02', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'ZZZ-2629', client: 'ZZZ', location: 'Mansfield, TX', numHoles: 4, numFeet: 80, jobDate: '2023-05-04', jobLength: 1, status: 'complete', createdDate: '2023-01-01'},
      //   {jobNumber: 'ZZZ-2630', client: 'ZZZ', location: 'Mesquite, TX', numHoles: 3, numFeet: 60, jobDate: '2023-05-04', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'EWL-26', client: 'EWL', location: 'Rose Hill, TX', numHoles: 5, numFeet: 200, jobDate: '2023-05-05', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'EWL-2', client: 'EWL', location: 'Rowlett, TX', numHoles: 2, numFeet: 30, jobDate: '2023-05-23', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'ZZZ-6', client: 'ZZZ', location: 'Saginaw, TX', numHoles: 2, numFeet: 40, jobDate: '2023-05-11', jobLength: 2, status: 'canceled', createdDate: '2023-01-01'},
      //   {jobNumber: 'EWL-666', client: 'EWL', location: 'Burleson, TX', numHoles: 1, numFeet: 20, jobDate: '2023-05-01', jobLength: 1, status: 'canceled', createdDate: '2023-01-01'},
      //   {jobNumber: 'AAA-123', client: 'AAA', location: 'Ft. Worth, TX', numHoles: 3, numFeet: 60, jobDate: '2023-05-12', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'AAA-456', client: 'AAA', location: 'Dallas, TX', numHoles: 5, numFeet: 100, jobDate: '2023-05-14', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'AAA-100', client: 'AAA', location: 'Bedford, TX', numHoles: 2, numFeet: 50, jobDate: '2023-05-25', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'AAA-200', client: 'AAA', location: 'Cedar Hill, TX', numHoles: 2, numFeet: 50, jobDate: '2023-05-26', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'AAA-300', client: 'AAA', location: 'Desoto, TX', numHoles: 2, numFeet: 50, jobDate: '2023-05-30', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'TER-7400', client: 'TER', location: 'Haltom City, TX', numHoles: 2, numFeet: 50, jobDate: '2023-05-28', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'TER-222', client: 'TER', location: 'Grand Prairie, TX', numHoles: 1, numFeet: 25, jobDate: '2023-05-11', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'TER-987', client: 'TER', location: 'Lewisville, TX', numHoles: 3, numFeet: 75, jobDate: '2023-05-12', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'EWL-5454', client: 'EWL', location: 'Carrolton, TX', numHoles: 4, numFeet: 100, jobDate: '2023-05-09', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'EWL-1234', client: 'EWL', location: 'Flower Mound, TX', numHoles: 1, numFeet: 20, jobDate: '2023-05-07', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'ZZZ-999', client: 'ZZZ', location: 'Justin, TX', numHoles: 2, numFeet: 40, jobDate: '2023-05-14', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'ZZZ-889', client: 'ZZZ', location: 'Prosper, TX', numHoles: 1, numFeet: 20, jobDate: '2023-05-22', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'AAA-112', client: 'AAA', location: 'Grapevine, TX', numHoles: 1, numFeet: 50, jobDate: '2023-05-24', jobLength: 1, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'AAA-567', client: 'AAA', location: 'Crowley, TX', numHoles: 2, numFeet: 100, jobDate: '2023-05-29', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      //   {jobNumber: 'EWL-876', client: 'EWL', location: 'Midlothian, TX', numHoles: 4, numFeet: 200, jobDate: '2023-05-19', jobLength: 2, status: 'pending', createdDate: '2023-01-01'},
      // ];
